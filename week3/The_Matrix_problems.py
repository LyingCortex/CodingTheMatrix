...
## 6: (Problem 6) Matrix-matrix multiplication practice with small matrices # Please represent your answer as a list of row lists.
# Example: [[1,1],[2,2]]
...
def lin_comb_mat_vec_mult(M, v):
    ...
    '''
    assert(M.D[1] == v.D)
##    return Vec(M.D[0],{r:sum([v[x[1]]* y for (x,y) in M.f.items() if x[0]==r]) for r in M.D[0]})
